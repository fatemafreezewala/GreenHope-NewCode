  ...
  return (
    <View style={styles.container}>
      ...
      <View
        ...
        <ScrollView>
          <Text style={styles.head}>Session Details</Text>
          ...
          {feelingsone.rate != '' ? (
            <View>
              <Text style={styles.main}>Rating</Text>
              <View
                style={{
                  width: 200,
                  height: 40,
          ...
          <Text style={styles.mainextra}>Symptoms (Before)</Text>
          ...
          {feelingsone.review_status == 'complete' ? (
            <View>
              <Text style={styles.mainextra}>Symptoms (After)</Text>
          ...
          <Text style={styles.mainextra}>Felt Like:</Text>
          ...
          {feelingsone.notes != '' ? (
            <View>
              <Text style={styles.main}>Notes</Text>
          ...
          {feelingsone.review != '' ? (
            <View>
              <Text style={styles.main}>Review</Text>
